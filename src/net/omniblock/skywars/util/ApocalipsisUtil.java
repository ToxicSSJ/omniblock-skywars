				...
				if (rusher_cooldown == 0) {
					...
					new BukkitRunnable() {
						...
						public void run() {
							...
							z.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE, 20 * 200, 2, true),
									true);
							z.addPotionEffect(new PotionEffect(PotionEffectType.JUMP, 20 * 200, 1, true), true);

							z.getEquipment().setHelmet(new ItemBuilder(Material.LEATHER_HELMET)
									.enchant(Enchantment.FIRE_ASPECT, 1).build());
							z.getEquipment().setHelmet(new ItemBuilder(Material.LEATHER_BOOTS)
									.enchant(Enchantment.PROTECTION_FALL, 1000).build());

							z.getEquipment().setItemInHand(
									new ItemBuilder(Material.BONE).enchant(Enchantment.FIRE_ASPECT, 1).build());
