...
public class SpawnBlock {
	...
	public static List<Block> blockGeneratorInList(Block block, int xn, int yn, int zn, int rx, int ry, int rz,
			int numberofblock) {
	...
	// TE CREA COLUMNAS
	public static void columns(Block block, int xn, int yn, int zn, int rx, int ry, int rz, int numberofcolumns,
			int height, boolean Columns) {
	...
	public static void columnsInList(Block block, int xn, int zn, int yn, int rx, int ry, int rz, int numberofcolumns,
			int height, boolean Columns) {
		List<String> numberplace = new ArrayList<String>();
