package net.omniblock.skywars.util.effectlib;

import net.omniblock.skywars.Skywars;
import net.omniblock.skywars.util.effectlib.entity.EntityManager;
import net.omniblock.skywars.util.effectlib.listener.ItemListener;
...
public final class EffectLib extends JavaPlugin {
	...
	private static void loadListeners() {
		Skywars.getInstance().getServer().getPluginManager().registerEvents(new ItemListener(), Skywars.getInstance());
	}
