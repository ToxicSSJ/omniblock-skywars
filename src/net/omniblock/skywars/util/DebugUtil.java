...
public class DebugUtil {
	...
	private static int lastDay = 0; //usado para saber si el logger debe o no cambiar de archivo.
	...
	public static void setupLogger() {
		...
		String logFileName = c.get(Calendar.DAY_OF_MONTH) + "_" + (c.get(Calendar.MONTH) + 1) + "_" + c.get(Calendar.YEAR) + "_" + c.get(Calendar.HOUR_OF_DAY) + "-" + c.get(Calendar.MINUTE) + "-" + c.get(Calendar.SECOND) + ".log";
