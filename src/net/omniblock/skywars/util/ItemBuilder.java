...
public class ItemBuilder {
    ...
    public ItemBuilder lore(String line) {
        ...
        lore.add(andSymbol ? ChatColor.translateAlternateColorCodes('&', TextUtil.format(line)) : TextUtil.format(line));
        return this;
    }
    /**
    ...
    public ItemBuilder lore(String line, int index) {
        Validate.notNull(TextUtil.format(line), "The Line is null.");
        lore.set(index, andSymbol ? ChatColor.translateAlternateColorCodes('&', TextUtil.format(line)) : TextUtil.format(line));
        return this;
    }
    /**
