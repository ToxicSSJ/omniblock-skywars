					...
					case FINISHING:
						...
						for (Player infinish_p : TeamPlayerManager.getPlayersInGameList()) {
							ScoreboardUtil.unrankedSidebarDisplay(infinish_p, new String[] { title,
									...
									TextUtil.format("&b&lExperiencia: &9&l+&9"
											+ TeamPlayerBattleListener.battle_info.get(infinish_p).getTotalExp()),
						...
						for (Player spectator_p : SpectatorManager.playersSpectators) {
							ScoreboardUtil.unrankedSidebarDisplay(spectator_p, new String[] { title,
									...
									TextUtil.format("&b&lExperiencia: &9&l+&9"
											+ TeamPlayerBattleListener.battle_info.get(spectator_p).getTotalExp()),
									TextUtil.format("    "), TextUtil.format("&ewww.omniblock.net") }, false);
						}
						break;
					case IN_GAME:
						...
						for (Player ingame_p : TeamPlayerManager.getPlayersInGameList()) {
							ScoreboardUtil.unrankedSidebarDisplay(ingame_p, new String[] { title,
									TextUtil.format("&7&o   Modo " + INGAME_MATCH_PLUS_FORMAT), TextUtil.format(" "),
									TextUtil.format(INGAME_NEXT_EVENT), TextUtil.format("  "),
									TextUtil.format("&b&lEquipo: &a"
											+ TeamPlayerBattleListener.battle_info.get(ingame_p).getAlliedStatus()),
									TextUtil.format("   "),
									TextUtil.format("&b&lAsesinatos: &a"
											+ TeamPlayerBattleListener.battle_info.get(ingame_p).kills),
									TextUtil.format("&b&lAsistencias: &a"
											+ TeamPlayerBattleListener.battle_info.get(ingame_p).assistences),
						...
						for (Player ingame_p : SpectatorManager.playersSpectators) {
							ScoreboardUtil.unrankedSidebarDisplay(ingame_p, new String[] { title,
									TextUtil.format("&7&o   Modo " + INGAME_MATCH_PLUS_FORMAT), TextUtil.format(" "),
									TextUtil.format(INGAME_NEXT_EVENT), TextUtil.format("  "),
									TextUtil.format("&b&lEquipo: &a"
