...
public class BlockPresets {
    ...
    protected static final ChestPack[] NORMAL_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            ...
            .addContent(new ItemBuilder(Material.LEATHER_CHESTPLATE).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            ...
            .addContent(new ItemBuilder(Material.LOG).amount(3).build())
            .addContent(new ItemBuilder(Material.LEATHER_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.WOOD).amount(12).build())
            .addContent(new ItemBuilder(Material.BRICK).amount(6).build())
            .addContent(new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).amount(1).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.STONE).amount(16).build())
            .addContent(new ItemBuilder(Material.IRON_PICKAXE).enchant(Enchantment.DIG_SPEED, 2).amount(1).build())
    ...
    protected static final ChestPack[] INSANE_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            ...
            .addContent(new ItemBuilder(Material.GOLD_CHESTPLATE).enchant(Enchantment.DURABILITY, 2).amount(1).build())
            ...
            .addContent(new ItemBuilder(Material.STONE).amount(12).build())
            .addContent(new ItemBuilder(Material.STONE).amount(8).build())
            .addContent(new ItemBuilder(Material.GOLD_PICKAXE).enchant(Enchantment.DIG_SPEED, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.IRON_CHESTPLATE).enchant(Enchantment.DURABILITY, 1).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 2).amount(1).build()),
            ...
            .addContent(new ItemBuilder(Material.DIAMOND_PICKAXE).enchant(Enchantment.DIG_SPEED, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.DIAMOND_CHESTPLATE).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.BRICK).amount(12).build())
            .addContent(new ItemBuilder(Material.STONE).amount(6).build())
            .addContent(new ItemBuilder(Material.STONE_PICKAXE).enchant(Enchantment.DIG_SPEED, 3).amount(1).build())
            .addContent(new ItemBuilder(Material.DIAMOND_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.STONE).amount(12).build())
            .addContent(new ItemBuilder(Material.STONE).amount(8).build())
            .addContent(new ItemBuilder(Material.IRON_CHESTPLATE).enchant(Enchantment.PROTECTION_FIRE, 2).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.FISHING_ROD).enchant(Enchantment.FIRE_ASPECT, 1).enchant(Enchantment.KNOCKBACK, 2).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.STONE).amount(12).build())
            .addContent(new ItemBuilder(Material.STONE).amount(8).build())
            .addContent(new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.FISHING_ROD).enchant(Enchantment.FIRE_ASPECT, 1).enchant(Enchantment.KNOCKBACK, 2).amount(1).build()),
            ...
            .addContent(new ItemBuilder(Material.WOOD).amount(12).build())
            .addContent(new ItemBuilder(Material.BRICK).amount(6).build())
            .addContent(new ItemBuilder(Material.IRON_CHESTPLATE).enchant(Enchantment.PROTECTION_PROJECTILE, 1).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.POTION).durability((short) 16417).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.WOOD).amount(12).build())
            .addContent(new ItemBuilder(Material.BRICK).amount(6).build())
            .addContent(new ItemBuilder(Material.DIAMOND_CHESTPLATE).enchant(Enchantment.PROTECTION_PROJECTILE, 1).enchant(Enchantment.PROTECTION_FIRE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.POTION).durability((short) 16417).amount(1).build()),
    ...
    protected static final ChestPack[] LEGENDARY_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            ...
            .addContent(new ItemBuilder(Material.DIAMOND_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 5).enchant(Enchantment.PROTECTION_FIRE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.WOOD).amount(4).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.WOOD).amount(12).build())
            .addContent(new ItemBuilder(Material.WOOD).amount(4).build())
            .addContent(new ItemBuilder(Material.STONE_AXE).enchant(Enchantment.DIG_SPEED, 5).enchant(Enchantment.DURABILITY, 5).amount(4).build())
            ...
            .addContent(new ItemBuilder(Material.STONE).amount(12).build())
            .addContent(new ItemBuilder(Material.BRICK).amount(4).build())
            .addContent(new ItemBuilder(Material.DIAMOND_PICKAXE).enchant(Enchantment.DIG_SPEED, 5).enchant(Enchantment.DURABILITY, 5).amount(4).build())
            .addContent(ImprovedItemType.PECHERA_MECANICA.getItem())
            .addContent(new ItemBuilder(Material.BRICK).amount(4).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.BRICK).amount(12).build())
            .addContent(new ItemBuilder(Material.IRON_PICKAXE).enchant(Enchantment.DIG_SPEED, 4).enchant(Enchantment.DURABILITY, 4).amount(4).build())
            .addContent(ImprovedItemType.PECHERA_MECANICA.getItem())
            ...
            .addContent(new ItemBuilder(Material.STONE_PICKAXE).enchant(Enchantment.DIG_SPEED, 3).amount(1).build())
            .addContent(new ItemBuilder(Material.DIAMOND_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 5).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.STONE).amount(12).build())
            .addContent(new ItemBuilder(Material.STONE).amount(8).build())
            .addContent(LegendaryItemType.BOMBARDERO.getItem())
            .addContent(new ItemBuilder(Material.IRON_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 5).enchant(Enchantment.PROTECTION_FIRE, 2).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.FISHING_ROD).enchant(Enchantment.FIRE_ASPECT, 1).enchant(Enchantment.KNOCKBACK, 2).amount(1).build()),
            ...
            .addContent(new ItemBuilder(Material.CHAINMAIL_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 7).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.FISHING_ROD).enchant(Enchantment.FIRE_ASPECT, 1).enchant(Enchantment.KNOCKBACK, 2).amount(1).build()),
            ...
            .addContent(new ItemBuilder(Material.LEATHER_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 7).enchant(Enchantment.PROTECTION_PROJECTILE, 3).amount(1).build())
            .addContent(new ItemBuilder(Material.POTION).durability((short) 16418).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.WOOD).amount(14).build())
            .addContent(new ItemBuilder(Material.WOOD).amount(6).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(4).build())
            .addContent(LegendaryItemType.BOLA_CONGELACEREBROS.getItem())
            .addContent(new ItemBuilder(Material.IRON_AXE).enchant(Enchantment.DIG_SPEED, 4).enchant(Enchantment.DURABILITY, 4).amount(1).build())
            .addContent(ImprovedItemType.PECHERA_ESTELAR.getItem()),
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.STONE).amount(14).build())
            .addContent(new ItemBuilder(Material.STONE).amount(6).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(2).build())
            .addContent(new ItemBuilder(Material.DIAMOND_PICKAXE).enchant(Enchantment.DIG_SPEED, 4).enchant(Enchantment.DURABILITY, 4).amount(1).build())
