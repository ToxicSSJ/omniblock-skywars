...
public class CenterPresets {
    ...
    protected static final ChestPack[] NORMAL_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            .addContent(new ItemBuilder(Material.IRON_SWORD).enchant(Enchantment.FIRE_ASPECT, 2).amount(1).build())
            ...
            .addContent(new ItemBuilder(Material.CHAINMAIL_LEGGINGS).enchant(Enchantment.DURABILITY, 2).enchant(Enchantment.PROTECTION_PROJECTILE, 1).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.DIAMOND_SWORD).enchant(Enchantment.DURABILITY, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(1).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(1).build())
            .addContent(new ItemBuilder(Material.ARROW, 10).amount(1).build())
            .addContent(new ItemBuilder(Material.ARROW, 8).amount(1).build())
            .addContent(new ItemBuilder(Material.FISHING_ROD).enchant(Enchantment.KNOCKBACK, 1).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.IRON_CHESTPLATE).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.ARROW, 8).amount(1).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.IRON_BOOTS).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).enchant(Enchantment.PROTECTION_FALL, 2).amount(1).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.STONE_SWORD).enchant(Enchantment.DAMAGE_ALL, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.WOOD_SWORD).enchant(Enchantment.KNOCKBACK, 1).amount(1).build())
            ...
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(1).build())
            .addContent(new ItemBuilder(Material.DIAMOND_CHESTPLATE).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.DIAMOND_HELMET).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.DIAMOND_AXE).enchant(Enchantment.DAMAGE_ALL, 1).amount(1).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(2).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(1).build())
            .addContent(new ItemBuilder(Material.DIAMOND_BOOTS).enchant(Enchantment.PROTECTION_FALL, 2).amount(1).build()),
    ...
    protected static final ChestPack[] INSANE_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            .addContent(new ItemBuilder(Material.IRON_SWORD).enchant(Enchantment.DAMAGE_ALL, 4).amount(1).build())
    ...
    protected static final ChestPack[] LEGENDARY_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_MUTTON).amount(10).build())
            .addContent(new ItemBuilder(Material.DIAMOND_LEGGINGS).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 8).amount(12).build())
            ...
            .addContent(new ItemBuilder(Material.ARROW).amount(10).build())
            .addContent(new ItemBuilder(Material.DIAMOND_BOOTS).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 8).amount(12).build())
            .addContent(ImprovedItemType.ARCO_PODEROSO.getItem())
            .addContent(LegendaryItemType.BOLA_CONGELACEREBROS.getItem()),
