...
public class FoodPresets {
    ...
    protected static final ChestPack[] NORMAL_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_MUTTON).amount(8).build())
            .addContent(new ItemBuilder(Material.EGG).amount(18).build())
            .addContent(new ItemBuilder(Material.EXP_BOTTLE).amount(16).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_BEEF).amount(6).build())
            .addContent(new ItemBuilder(Material.EGG).amount(18).build())
            .addContent(new ItemBuilder(Material.STONE).amount(16).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_MUTTON).amount(6).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_BEEF).amount(12).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_MUTTON).amount(12).build())
    ...
    protected static final ChestPack[] INSANE_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            ...
            .addContent(new ItemBuilder(Material.LEATHER_HELMET).enchant(Enchantment.PROTECTION_ENVIRONMENTAL, 1).amount(1).build())
            .addContent(new ItemBuilder(Material.WATER_BUCKET).amount(1).build()),
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(3).build())
            .addContent(new ItemBuilder(Material.EGG).amount(12).build())
            .addContent(new ItemBuilder(Material.CHAINMAIL_HELMET).enchant(Enchantment.PROTECTION_PROJECTILE, 1).amount(1).build())
            .addContent(new ItemBuilder(Material.STONE).amount(16).build())
            .addContent(new ItemBuilder(Material.LAVA_BUCKET).amount(1).build()),
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_MUTTON).amount(5).build())
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(2).build())
            .addContent(new ItemBuilder(Material.LAVA_BUCKET).amount(1).build())
            .addContent(new ItemBuilder(Material.EGG).amount(16).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_MUTTON).amount(3).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.APPLE).amount(3).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.BAKED_POTATO).amount(8).build())
            .addContent(new ItemBuilder(Material.WATER_BUCKET).amount(1).build())
            .addContent(new ItemBuilder(Material.SNOW_BALL).amount(12).build())
            .addContent(ImprovedItemType.TNT.getItem()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.BAKED_POTATO).amount(6).build())
            .addContent(new ItemBuilder(Material.LAVA_BUCKET).amount(1).build())
            .addContent(new ItemBuilder(Material.EGG).amount(12).build())
            .addContent(new ItemBuilder(Material.IRON_HELMET).enchant(Enchantment.PROTECTION_PROJECTILE, 2).amount(1).build())
            .addContent(new ItemBuilder(Material.EXP_BOTTLE).amount(12).build()),
    ...
    protected static final ChestPack[] LEGENDARY_CHESTPACKS = new ChestPack[] {
        ...
        new ChestPack()
            .addContent(new ItemBuilder(Material.COOKED_BEEF).amount(16).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(8).build())
            .addContent(new ItemBuilder(Material.EGG).amount(16).build())
            .addContent(ImprovedItemType.CASCO_FUGAZ.getItem())
            .addContent(ImprovedItemType.TNT.getItem())
            .addContent(ImprovedItemType.TNT.getItem())
            .addContent(new ItemBuilder(Material.FLINT_AND_STEEL).amount(1).build()),

            new ChestPack()
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(6).build())
            .addContent(ImprovedItemType.CASCO_BRILLANTE.getItem())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.RAW_BEEF).amount(8).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.GOLDEN_APPLE).amount(12).build())
            ...
            new ChestPack()
            .addContent(new ItemBuilder(Material.APPLE).amount(12).build())
