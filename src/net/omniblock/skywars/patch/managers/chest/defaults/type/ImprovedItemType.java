...
public enum ImprovedItemType {
    ...
    HACHA_VIKINGA(new ItemBuilder(Material.IRON_AXE).amount(1).name("&8&k||&r &c&lHacha Vikinga &8&k||")
            .lore("&8━━━━━━━━━━━━━━━━━━━━━━━━━").lore("&7Usada por los").lore("&7vikingos mas temidos")
            .lore("&7para destrozar a sus enemigos").lore("&8━━━━━━━━━━━━━━━━━━━━━━━━━")
            .enchant(Enchantment.DAMAGE_ALL, 3).enchant(Enchantment.DURABILITY, 3)
            .build()), OZ_INFERNAL(new ItemBuilder(Material.DIAMOND_HOE).amount(1)
            ...
            .enchant(
                Enchantment.DURABILITY,
                2)
            .build()), PANTALONES_BRILLANTES_II(
            new ItemBuilder(
